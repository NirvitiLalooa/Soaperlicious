...
<html> 
<head>
	<title>SEA BUCKTHORN SATSUMA SOAP</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div id="contents"> <!-- start of contents --> 
		...
		<h2><span>SEA BUCKTHORN SATSUMA SOAP</span></h2>
		<div id="menus">		
		<center>
		<table width="650" height="479" border="1">
			<tr>
				<th width="291" rowspan="3" scope="col">
				<img src="categories/OrganicSeaBuckthornSoap_large.jpg" width="350" height="350" alt="SEA BUCKTHORN SATSUMA" />
				<br><br>
				<font color="black" size="10"> RM 22.00 </font>
				</th>
				
				<th height="155" colspan="3" scope="col"><font color="black"> <BR><BR>
				<p>Our Sea Buckthorn Satsuma Organic complexion bar packs a punch. Brimming with life giving nutrients, Sea Buckthorn oil is full of antioxidants, beta carotene, vitamin A, C, E as well as Omega-7. It calms and rejuvenates inflamed problematic skin, giving you back your glow.  The tangerine Satsuma essential oil blend will gently awaken your skin leaving it refreshed, invigorated.</p></font></th>
			</tr>
			
			<tr>
				<td width="104" height="34" align="center"><a href="benSea.php" target="iframe_a">Benefit</a></td>
				<td width="126" align="center"><a href="ingSea.php" target="iframe_a">Ingredients</a></td>
				<td width="108" align="center"><a href="howSea.php" target="iframe_a">How To Use</a></td>
			</tr>
...
?>
			...
			<form name=frmAdd method="POST" action="balanise.php">
			<input type="hidden" name="txtemail" value="<?php echo $col[0];?>">
			<input type="hidden" value="SBS" name="pro_id">
			<input type="hidden" name="pro_img" value="categories/OrganicSeaBuckthornSoap_large.jpg">
			<input type="hidden" value="SEA BUCKTHORN SATSUMA" name="pro_name">
			<input type="hidden" value="22.00" name="pro_price">
