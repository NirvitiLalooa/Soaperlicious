...
<body>
	...
	<div id="contents"> <!-- start of contents --> 
		...
		<table width="650" height="479" border="1">
			...
			<tr>
				<td width="104" height="34" align="center"><a href="benRose.php" target="iframe_a">Benefit</a></td>
				<td width="126" align="center"><a href="ingRose.php" target="iframe_a">Ingredients</a></td>
				<td width="108" align="center"><a href="howRose.php" target="iframe_a">How To Use</a></td>
			</tr>
...
?>
			...
			<form name=frmAdd method="POST" action="rosewood.php">
			<input type="hidden" name="txtemail" value="<?php echo $col[0];?>">
			<input type="hidden" value="RW" name="pro_id">
			<input type="hidden" name="pro_img" value="categories/organichandmadesoapRosewood_large.jpg">
			<input type="hidden" value="ROSEWOOD" name="pro_name">
