...
<body>
	...
	<div id="contents"> <!-- start of contents --> 
		...
		<h2><span>PEPPERMINT BASIL SOAP</span></h2>
		<div id="menus">		
		<center>
		<table width="650" height="479" border="1">
			<tr>
				...
				<p>No longer have that “pep in your step?” Our Organic Peppermint Basil handmade soap will get your mojo working again! The bold peppermint scent is infused with a light whiff of Sweet Basil and will make every pore on your body come alive. Your skin will look and feel radiant!</p></font></th>
			</tr>
			
			<tr>
				<td width="104" height="34" align="center"><a href="benPepper.php" target="iframe_a">Benefit</a></td>
				<td width="126" align="center"><a href="ingPepper.php" target="iframe_a">Ingredients</a></td>
				<td width="108" align="center"><a href="howPepper.php" target="iframe_a">How To Use</a></td>
			</tr>
...
?>
			...
			<form name=frmAdd method="POST" action="balpepper.php">
			<input type="hidden" name="txtemail" value="<?php echo $col[0];?>">
			<input type="hidden" value="PB" name="pro_id">
			<input type="hidden" name="pro_img" value="categories/PeppermintPineOrganicSoap_large.jpg">
			<input type="hidden" value="PEPPERMINT BASIL" name="pro_name">
