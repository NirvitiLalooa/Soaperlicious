...
<html> 
<head>
	<title>MIX & MATCH SOAP SET</title>
	<meta charset="UTF-8">
...
<body>
  ...
  <tr>
	...
	<img src="gift/mixandmatch.jpg" width="350" height="350" alt="mixandmatch" />
	<br><br><font color="black" size="10"> RM 69.90 </font></th>
    <th height="155" colspan="3" scope="col"><font color="black"><h1>Mix &amp; Match Organic Soap Set</h1>
      <p>3 Pack</p>
    <p>Can't make up your mind as to which of our Handmade Organic Soaps to buy?  With our Mix and Match Organic Soap Set you get to try out three full size soaps of your choice. So buy a few sets and save.  Each of our soaps come beautifully packaged in a hand stitched muslin bag - gift ready.</p></font></th>
  </tr>
  <tr>
    <td width="104" height="34" align="center"><a href="benMIX.php" target="iframe_a">Benefit</a></td>
    <td width="126" align="center"><a href="ingMIX.php" target="iframe_a">Ingredients</a></td>
...
$result2 = mysqli_query($con,$query2);
 ...
 ?>
	...
	<input type="hidden" value="GS01" name="pro_id">
	<input type="hidden" name="pro_img" value="gift/mixandmatch.jpg">
	<input type="hidden" value="Mix and Match" name="pro_name">
	...
	<input type="image" value=submit name="btnAdd" src="images/addcart.png"  height="40" width="120" />	
		...
		<?php } else:?>
	<a href="signin.php"><input type="image" name="btnAdd" src="images/addcart.png"  height="40" width="120" /></a><br><br>
	<?php endif; ?> 
</form>
</center></td>
 </tr>
