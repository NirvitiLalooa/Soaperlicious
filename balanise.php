...
<html> 
<head>
	<title>ANISE BAMBOO CHARCOAL SOAP</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div id="contents"> <!-- start of contents --> 
		...
		<h2><span>ANISE BAMBOO CHARCOAL SOAP</span></h2>
		<div id="menus">		
		<center>
		<table width="650" height="479" border="1">
			<tr>
				<th width="291" rowspan="3" scope="col">
				<img src="categories/OrganicAniseBambooCharcoalSoap_large.jpg" width="350" height="350" alt="ANISE BAMBOO CHARCOAL" />
				<br><br>
				<font color="black" size="10"> RM 21.50 </font>
				</th>
				
				<th height="155" colspan="3" scope="col"><font color="black"> <BR><BR>
				<p>Can't make up your mind as to which of our Handmade Organic Soaps to buy?  With our Rosewood Soap you get to try out three full size soaps of your choice. So buy a few sets and save.  Each of our soaps come beautifully packaged in a hand stitched muslin bag - gift ready.</p></font></th>
			</tr>
			
			<tr>
				<td width="104" height="34" align="center"><a href="benAnise.php" target="iframe_a">Benefit</a></td>
				<td width="126" align="center"><a href="ingAnise.php" target="iframe_a">Ingredients</a></td>
				<td width="108" align="center"><a href="howAnise.php" target="iframe_a">How To Use</a></td>
			</tr>
...
?>
			...
			<input type="hidden" value="ABC" name="pro_id">
			<input type="hidden" name="pro_img" value="categories/OrganicAniseBambooCharcoalSoap_large.jpg">
			<input type="hidden" value="ANISE BAMBOO CHARCOAL" name="pro_name">
			<input type="hidden" value="21.50" name="pro_price">
