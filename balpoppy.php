...
<html> 
<head>
	<title>LEMON POPPY SEED SOAP</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div id="contents"> <!-- start of contents --> 
		...
		<h2><span>LEMON POPPY SEED SOAP</span></h2>
		<div id="menus">		
		<center>
		<table width="650" height="479" border="1">
			<tr>
				<th width="291" rowspan="3" scope="col">
				<img src="categories/LemonPoppyOrganicSoap_large.jpg" width="350" height="350" alt="LEMON POPPY SEED" />
				<br><br>
				<font color="black" size="10"> RM 23.00 </font>
				</th>
				
				<th height="155" colspan="3" scope="col"><font color="black"> <BR><BR>
				<p>This fun and delicious Lemon Poppy Seed organic body soap is even better than those scrumptious muffins by the same name! Lemon essential oil is an antimicrobial that aids in deep cleaning. Poppy seeds add an extra exfoliating element; softening your skin while exfoliating. Tangy and uplifting, you will be captivated by this bar after just one use!</p></font></th>
			</tr>
			
			<tr>
				<td width="104" height="34" align="center"><a href="benPoppy.php" target="iframe_a">Benefit</a></td>
				<td width="126" align="center"><a href="ingPoppy.php" target="iframe_a">Ingredients</a></td>
				<td width="108" align="center"><a href="howPoppy.php" target="iframe_a">How To Use</a></td>
			</tr>
...
?>
			...
			<form name=frmAdd method="POST" action="balpoppy.php">
			<input type="hidden" name="txtemail" value="<?php echo $col[0];?>">
			<input type="hidden" value="LPS" name="pro_id">
			<input type="hidden" name="pro_img" value="categories/LemonPoppyOrganicSoap_large.jpg">
			<input type="hidden" value="LEMON POPPY SEED" name="pro_name">
			<input type="hidden" value="23.00" name="pro_price">
