...
<html>
<head>
	<title>ORGANIC HANDMADE SOAP SAMPLER</title>
	<meta charset="UTF-8">
...
<body>
  ...
  <tr>
    <th width="291" rowspan="3" scope="col"><img src="gift/sampler1.jpg" width="350" height="350" alt="entire" />
	<br><br><font color="black" size="10"> RM49.90 </font></th>
    <th height="155" colspan="3" scope="col"><font color="black"><h1>Organic Handmade Soap Sampler</h1>
      
    <p>This is the perfect way to test drive our Organic Handmade Soaps.  Three kind of soaps will randomly be selected and we will send you 1oz of each bar.  These samples come with added character, they are from the end of our soap loaves and are not uniform by any means. Great travel soaps!</font></p>
</th>
  </tr>
  <tr>
    <td width="104" height="34" align="center"><a href="benSam.php" target="iframe_a">Benefit</a></td>
    <td width="126" align="center"><a href="ingSam.php" target="iframe_a">Ingredients</a></td>
...
$result2 = mysql_query($query2);
 ...
 ?>
	...
	<input type="hidden" value="GS07" name="pro_id">
	<input type="hidden" name="pro_img" value="gift/sampler1.jpg">
	<input type="hidden" value="Organic Body Soap Sampler" name="pro_name">
