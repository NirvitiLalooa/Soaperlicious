...
<html> 
<head>
	<title>Oatmeal Celendula SOAP</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div id="contents"> <!-- start of contents --> 
		...
		<h2><span>OATMEAL CELENDULA SOAP</span></h2>
		<div id="menus">		
		<center>
		<table width="650" height="479" border="1">
			<tr>
				<th width="291" rowspan="3" scope="col">
				<img src="categories/OrganicOatmealCalendulaSoap_large.jpg" width="350" height="350" alt="OATMEAL CELENDULA" />
				<br><br>
				<font color="black" size="10"> RM 22.50 </font>
				</th>
				
				<th height="155" colspan="3" scope="col"><font color="black"> <BR><BR>
				<p>If you are in search of an unscented, soothing organic baby soap, then you have found it! Offering the best of both worlds, our Unscented Oatmeal Calendula soap gently cleanses while leaving babies skin moisturized. Oatmeal and calendula work in tandem nourish dry & flaky skin.</p></font></th>
			</tr>
			
			<tr>
				<td width="104" height="34" align="center"><a href="benOat.php" target="iframe_a">Benefit</a></td>
				<td width="126" align="center"><a href="ingOat.php" target="iframe_a">Ingredients</a></td>
				<td width="108" align="center"><a href="howOat.php" target="iframe_a">How To Use</a></td>
			</tr>
...
?>
			...
			<form name=frmAdd method="POST" action="baloatmeal.php">
			<input type="hidden" name="txtemail" value="<?php echo $col[0];?>">
			<input type="hidden" value="OC" name="pro_id">
			<input type="hidden" name="pro_img" value="categories/OrganicOatmealCalendulaSoap_large.jpg">
			<input type="hidden" value="OATMEAL CALENDULA" name="pro_name">
