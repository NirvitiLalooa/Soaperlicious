...
<html>
<head>
	<title>Lip Love + Organic Soap Gift Pack</title>
	<meta charset="UTF-8">
...
<ul id="infos">
  ...
  <tr>
    ...
    <th width="291" rowspan="3" scope="col"><img src="gift/liplove.jpg" width="350" height="350" alt="liplove" />
	<br><br><font color="black" size="10"> RM 69.90 </font></th>
    <th height="155" colspan="3" scope="col"><font color="black"><h1>Lip Love + Organic Soap Gift Pack</h1>
      <p>Need a quick gift that is sure to please!  Our Hello Sunshine Lip Love + Lemon Poppy Organic Soap is wrapped beautifully and ready to give.</font></p>
   </th>
  </tr>
  <tr>
    <td width="104" height="34" align="center"><a href="benLip.php" target="iframe_a">Benefit</a></td>
    <td width="126" align="center"><a href="ingLip.php" target="iframe_a">Ingredients</a></td>
...
$result2 = mysql_query($query2);
 ...
 ?>
	<form name=frmAdd method="post" action="liplove.php">
	
	<input type="hidden" name="txtemail" value="<?php echo $col[0];?>">
	<input type="hidden" value="GS04" name="pro_id">
	<input type="hidden" name="pro_img" value="gift/liplove.jpg">
	<input type="hidden" value="Lip Love + Organic Soap Gift Pack" name="pro_name">
