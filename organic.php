...
<html>
<head>
	<title>ORGANIC BODY SOAP SET</title>
	<meta charset="UTF-8">
...
<body>
  ...
  <tr>
    <th width="291" rowspan="3" scope="col"><img src="gift/organic.jpg" width="350" height="350" alt="organic" />
	<br><br><font color="black" size="10"> RM 59.90 </font></th>
    <th height="155" colspan="3" scope="col"><font color="black"><h1>Organic Body Soap Set</h1>
      <p>Why should your face get to have all the fun? Our Organic Body Soap Set combines three of our favorite body soaps sure to redefine the way you enjoy shower time. Rest easy knowing you’ll never find sulfates, detergents, synthetics, animal products, artificial fragrances, colorants, petroleum, phthalates or GMOs in any of our products. What you will find are certified organic ingredients, beneficial therapeutic essential oils and healing botanical extracts coming together in handcrafted batches made with love. 

Each Organic Body Soap Set contains: 1 bar (3.5 oz) Lemon Poppy Seed soap, 1 bar (3.5 oz) Peppermint Basil soap, 1 bar (3.5 oz) Oatmeal Calendula soap.</font></p>
    <p></th>
  </tr>
  
  <tr>
    <td width="104" height="34" align="center"><a href="benOrg.php" target="iframe_a">Benefit</a></td>
    <td width="126" align="center"><a href="ingOrg.php" target="iframe_a">Ingredients</a></td>
...
$result2 = mysqli_query($con,$query2);
 ...
 ?>
	<form name=frmAdd method="post" action="organic.php">
	
	<input type="hidden" name="txtemail" value="<?php echo $col[0];?>">
	<input type="hidden" value="GS05" name="pro_id">
	<input type="hidden" name="pro_img" value="gift/organic.jpg">
	<input type="hidden" value="Organic Body Soap Set" name="pro_name">
